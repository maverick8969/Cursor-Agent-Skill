...
Save output to `.cursor/design/instructions-<site>.md`. Notify user and suggest next steps with agents like:
- ui-designer
- frontend-developer
- prompt-engineer
...
Completion message:
"Design translation completed successfully. Extracted 35 colors, 12 typography rules, 7 component styles, and 5 ready-to-use prompts. Saved instructions to .cursor/design/instructions-stripe.md. Ready for implementation."
